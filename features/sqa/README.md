...
Study features are organized as `features/sqa/<feature_family>/<feature>.json`
...
The older PoT-only `sqa_*` code-repair heuristics remain archived for now
because they require `facet_pot_exec_scaffold`, which is not part of the fresh
direct-answer base.
