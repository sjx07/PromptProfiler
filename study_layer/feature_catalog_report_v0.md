...
- Tasks: 14
- Concepts: 52
- Cross-task concepts: 36
- Duplicate `task::canonical_id` keys namespace-qualified: 18
...
- `rule_or_constraint`    : 371
- `reasoning_behavior`    : 183
- `input_context_builder` : 72
- `response_mode`         : 67
- `demonstration_policy`  : 3

## Implementation Surfaces

- `task_or_user_instruction` : 512
- `system_instruction`       : 86
- `auxiliary_output_field`   : 55
- `context_field`            : 24
- `output_contract`          : 16
- `input_transform`          : 3
...
- `prompt_only`          : 574
- `parser_change`        : 60
- `runtime_execution`    : 44
- `input_builder_change` : 18
...
- `rule.output_contract_control`                 : 58
- `rule.general_instruction`                     : 52
- `rule.decision_heuristic`                      : 49
- `rule.edge_case_handling`                      : 38
- `reasoning.trace_guidance`                     : 36
- `rule.idiom_shortcut`                          : 36
- `response.program_of_thought.python`           : 36
- `reasoning.verify_before_output`               : 34
- `input_context.domain_knowledge`               : 29
- `reasoning.aggregation_guidance`               : 28
- `reasoning.staged_reasoning`                   : 28
- `reasoning.verification_guidance`              : 26
- `rule.construction_constraint`                 : 26
- `rule.prompt_policy`                           : 24
- `input_context.evidence_summary`               : 23
- `reasoning.decomposition`                      : 20
- `response.visible_structured_trace`            : 15
- `structure.section.role`                       : 14
- `response.visible_cot`                         : 11
- `structure.section.rules`                      : 10
- `structure.section.task`                       : 10
- `structure.section.format_fix`                 : 10
- `structure.section.reasoning`                  : 9
- `structure.section.table_handling`             : 9
- `input_context.schema_use_guidance`            : 9
- `input_context.table_or_schema_representation` : 8
- `structure.section.strategy`                   : 7
- `response.direct_final_only`                   : 4
- `demonstration.few_shot`                       : 3
- `reasoning.enumerate_then_select`              : 3
- `reasoning.extract_then_compute`               : 3
- `structure.section.examples`                   : 2
- `structure.section.procedure`                  : 2
...
- `reasoning.filter_then_extract`                : 2
- `structure.section.final_answer`               : 1
- `structure.section.create_query_hop3`          : 1
...
- `rule.output_contract_control`: 8 tasks (bird, hotpotqa_context, spider, sqa, sql_generation, tabfact, table_qa, wtq)
...
- `reasoning.enumerate_then_select`: 3 tasks (table_qa, tablebench, wtq)
...
- `input_context.table_or_schema_representation`: 2 tasks (sql_generation, table_qa)
...
- `bird::_section_examples` -> `structure.section.examples` (rule_or_constraint, system_instruction, prompt_only): low-confidence taxonomy inference; no semantic_labels metadata; structural section component
- `bird::_section_procedure` -> `structure.section.procedure` (rule_or_constraint, system_instruction, prompt_only): low-confidence taxonomy inference; no semantic_labels metadata; structural section component
- `bird::_section_role` -> `structure.section.role` (rule_or_constraint, system_instruction, prompt_only): low-confidence taxonomy inference; no semantic_labels metadata; structural section component
- `bird::_section_rules` -> `structure.section.rules` (rule_or_constraint, system_instruction, prompt_only): low-confidence taxonomy inference; no semantic_labels metadata; structural section component
- `bird::_section_task` -> `structure.section.task` (rule_or_constraint, system_instruction, prompt_only): low-confidence taxonomy inference; no semantic_labels metadata; structural section component
- `hitab::_section_format_fix` -> `structure.section.format_fix` (rule_or_constraint, system_instruction, prompt_only): low-confidence taxonomy inference; no semantic_labels metadata; structural section component
- `hitab::_section_reasoning` -> `structure.section.reasoning` (rule_or_constraint, system_instruction, prompt_only): low-confidence taxonomy inference; no semantic_labels metadata; structural section component
- `hitab::_section_role` -> `structure.section.role` (rule_or_constraint, system_instruction, prompt_only): low-confidence taxonomy inference; no semantic_labels metadata; structural section component
- `hitab::_section_rules` -> `structure.section.rules` (rule_or_constraint, system_instruction, prompt_only): low-confidence taxonomy inference; no semantic_labels metadata; structural section component
- `hitab::_section_table_handling` -> `structure.section.table_handling` (rule_or_constraint, system_instruction, prompt_only): low-confidence taxonomy inference; no semantic_labels metadata; structural section component
- `hitab::_section_task` -> `structure.section.task` (rule_or_constraint, system_instruction, prompt_only): low-confidence taxonomy inference; no semantic_labels metadata; structural section component
...
- `spider::_section_examples` -> `structure.section.examples` (rule_or_constraint, system_instruction, prompt_only): low-confidence taxonomy inference; no semantic_labels metadata; structural section component
- `spider::_section_procedure` -> `structure.section.procedure` (rule_or_constraint, system_instruction, prompt_only): low-confidence taxonomy inference; no semantic_labels metadata; structural section component
- `spider::_section_role` -> `structure.section.role` (rule_or_constraint, system_instruction, prompt_only): low-confidence taxonomy inference; no semantic_labels metadata; structural section component
- `spider::_section_rules` -> `structure.section.rules` (rule_or_constraint, system_instruction, prompt_only): low-confidence taxonomy inference; no semantic_labels metadata; structural section component
- `spider::_section_task` -> `structure.section.task` (rule_or_constraint, system_instruction, prompt_only): low-confidence taxonomy inference; no semantic_labels metadata; structural section component
...
- `sqa::_section_table_handling@features` -> `structure.section.table_handling` (rule_or_constraint, context_field, input_builder_change): duplicate task::canonical_id; namespace-qualified with source root; low-confidence taxonomy inference; no semantic_labels metadata; structural section component
...
- `tabfact::_section_table_handling@features` -> `structure.section.table_handling` (rule_or_constraint, context_field, input_builder_change): duplicate task::canonical_id; namespace-qualified with source root; low-confidence taxonomy inference; no semantic_labels metadata; structural section component
...
- `table_qa::question_first_recap` -> `rule.general_instruction` (rule_or_constraint, task_or_user_instruction, prompt_only): low-confidence taxonomy inference; no semantic_labels metadata
- `table_qa::register_careful_explicit` -> `rule.general_instruction` (rule_or_constraint, task_or_user_instruction, prompt_only): low-confidence taxonomy inference; no semantic_labels metadata
- `table_qa::register_concise_literal` -> `rule.general_instruction` (rule_or_constraint, task_or_user_instruction, prompt_only): low-confidence taxonomy inference; no semantic_labels metadata
- `table_qa::self_check_grounded` -> `rule.general_instruction` (rule_or_constraint, task_or_user_instruction, prompt_only): low-confidence taxonomy inference; no semantic_labels metadata
- `table_qa::self_check_scan_complete` -> `rule.general_instruction` (rule_or_constraint, task_or_user_instruction, prompt_only): low-confidence taxonomy inference; no semantic_labels metadata
- `table_qa::self_confidence_gate` -> `rule.general_instruction` (rule_or_constraint, task_or_user_instruction, prompt_only): low-confidence taxonomy inference; no semantic_labels metadata
- `table_qa::self_cross_check_specific_cell` -> `rule.general_instruction` (rule_or_constraint, task_or_user_instruction, prompt_only): low-confidence taxonomy inference; no semantic_labels metadata
- `table_qa::self_recompute_once` -> `rule.general_instruction` (rule_or_constraint, task_or_user_instruction, prompt_only): low-confidence taxonomy inference; no semantic_labels metadata
- `table_qa::slow_down_breath` -> `rule.general_instruction` (rule_or_constraint, task_or_user_instruction, prompt_only): low-confidence taxonomy inference; no semantic_labels metadata
- `table_qa::talk_to_yourself` -> `rule.general_instruction` (rule_or_constraint, task_or_user_instruction, prompt_only): low-confidence taxonomy inference; no semantic_labels metadata
- `table_qa::_section_format_fix` -> `structure.section.format_fix` (rule_or_constraint, system_instruction, prompt_only): low-confidence taxonomy inference; no semantic_labels metadata; structural section component
- `table_qa::_section_reasoning` -> `structure.section.reasoning` (rule_or_constraint, system_instruction, prompt_only): low-confidence taxonomy inference; no semantic_labels metadata; structural section component
- `table_qa::_section_role` -> `structure.section.role` (rule_or_constraint, system_instruction, prompt_only): low-confidence taxonomy inference; no semantic_labels metadata; structural section component
- `table_qa::_section_strategy` -> `structure.section.strategy` (rule_or_constraint, system_instruction, prompt_only): low-confidence taxonomy inference; no semantic_labels metadata; structural section component
- `table_qa::_section_table_handling` -> `structure.section.table_handling` (rule_or_constraint, system_instruction, prompt_only): low-confidence taxonomy inference; no semantic_labels metadata; structural section component
- `tablebench::_section_format_fix` -> `structure.section.format_fix` (rule_or_constraint, system_instruction, prompt_only): low-confidence taxonomy inference; no semantic_labels metadata; structural section component
- ... 20 additional review rows omitted from report
